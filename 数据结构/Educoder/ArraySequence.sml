...
val a = Array.array(6,(1,1));
Array.update(a,1,(1,2));
Array.update(a,2,(2,2));
Array.update(a,3,(3,3));
val s ={ary = a, idx = 0, len = Array.length a};
unzip (sort (fn ((x,_), (y,_)) => cmp (x, y)) s);
collect cmp s;
